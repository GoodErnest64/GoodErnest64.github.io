...
export default function Footer() {
  return (
    <div className="flex flex-col items-center justify-center bg-gray-900 text-white p-2 w-full h-max ring ring-gray-900">
      <h1 className="text-3xl font-extrabold">Ge64</h1>
      <h3 className="text-lg font-bold m-3">My Socials : </h3>
      <ul>
        <div className="flex justify-between w-64 mb-5 links">
          <a href="https://github.com/GoodErnest64" className="flex font-semibold gap-2">
          ...
          <a href="https://twitter.com/GoodErnest64" className="flex font-semibold gap-2">
          ...
          <Link to="/" className="flex font-semibold gap-2">
          ...
          <Link to="/rss.xml" className="flex font-semibold gap-2">
      ...
      <p>Proudly Hosted By <a href="https://pages.github.com/" className="font-semibold">Github Pages</a> !</p>
    </div>
  );
}